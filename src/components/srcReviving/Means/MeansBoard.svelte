<script>
  ...
  import { AnsList, CusList, resMean, reswholekey } from "../store";
...
<div class = 'containMeansBoard'>
  
    <div class = 'titleQues' id = {"QuesMean"+`${sort}`} style="background-color: {theme};">
        <div class = 'containfu' id = {'furword'+`${sort}`}  style="color: {fontTheme};"></div>
